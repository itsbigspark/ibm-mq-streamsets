...
public class JmsMessageConsumerFactoryImpl implements JmsMessageConsumerFactory {
    ...
    @Override
    public JmsMessageConsumer create(InitialContext initialContext, JmsConnectionFactory connectionFactory,
                                     BasicConfig basicConfig,
                                     JmsSourceConfig jmsConfig, JmsMessageConverter jmsMessageConverter) {
        return new JmsMessageConsumerImpl(initialContext, connectionFactory, basicConfig,
