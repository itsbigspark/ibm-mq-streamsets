...
public interface JmsMessageProcessor {
     ...
     */
    List<Stage.ConfigIssue> init(Processor.Context context);
     ...
     */
    int put(Batch batch, SingleLaneProcessor.SingleLaneBatchMaker singleLaneBatchMaker) throws StageException;
